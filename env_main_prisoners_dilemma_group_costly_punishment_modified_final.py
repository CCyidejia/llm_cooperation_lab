...
async def main():
    ...
    for experiment_index in range(REPEAT_TIMES):
        ...
        rational_profile = (
            ...
            "- If you choose Yes and [OPPONENT_NAME] chooses Punish: You get -1 points, [OPPONENT_NAME] gets 2 points "
            "- If you choose Punish and [OPPONENT_NAME] chooses Yes: You get 2 points, [OPPONENT_NAME] gets -1 points "
            "- If you choose No and [OPPONENT_NAME] chooses Punish: You get 1 point, [OPPONENT_NAME] gets -1 point "
            "- If you choose Punish and [OPPONENT_NAME] chooses No: You get -1 point, [OPPONENT_NAME] gets 1 point "
            "- If both choose Punish: You get -5 points, [OPPONENT_NAME] gets -5 points "
