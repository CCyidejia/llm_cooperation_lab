...
os.makedirs("result_public_goods_group_altruistic_punishment_consequence_prompt", exist_ok=True)
...
async def main(base_experiment_name, experiment_index):
    ...
    base_result_dir = "result_public_goods_group_altruistic_punishment_consequence_prompt"
