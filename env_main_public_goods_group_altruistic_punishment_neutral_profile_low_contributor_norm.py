...
os.makedirs("result_public_goods_group_altruistic_punishment_neutral_low_contributor_norm", exist_ok=True)
...
async def main(base_experiment_name, experiment_index):
    ...
    base_result_dir = "result_public_goods_group_altruistic_punishment_neutral_low_contributor_norm"
    ...
    for i in range(EXPERIMENT_SETTINGS["num_agents"]):
        ...
        profile = f"You are a participant in a game. After contributions are revealed, punishment is intended to sanction low contributors."
